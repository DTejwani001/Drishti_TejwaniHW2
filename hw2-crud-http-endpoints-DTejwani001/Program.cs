...
app.MapGet("/authors", (IAuthorService authorService) => {
...
app.MapGet("/authors/{id}", (int id, IAuthorsService authorService) => 
{
    // Use LINQ's FirstOrDefault method to search for a book with a matching ID in the list.
    // If no book is found, 'book' will be null.
...
app.MapPost("/authors", (Author newAuthor, IAuthorService authorService) =>
{
    // Add the new book to the list of books in the IBookService class.
...
app.MapPut("/authors/{id}", (int id, Author updatedAuthor, IAuthorService authorService) =>
{
...
app.MapDelete("/authors/{id}", (int id, IAuthorService authorService) =>
{
